...
List<SheetNote> parseJsonBsstVerion0_0(String s) {
  logger.v('parseJsonBsstVerion0_0: s.length=${s.length}');
            ...
            if (jsonSheetNotes is List) {
              ...
              for (var item in jsonSheetNotes) {
                ...
                if (item is Map) {
                  //  defaults only
                  bool isNote = true;
                  musicalKey.Key key = musicalKey.Key.byHalfStep();
                  ...
                  for (var attr in item.keys) {
                    switch (attr) {
                      ...
                      case 'chordN': //  encoded
                        ...
                        key = musicalKey.Key.byHalfStep(offset: chordN + 7);
                  ...
                  if (isNote) {
                    ...
                    //  rest
                    SheetNote sn = SheetNote.rest(_noteDuration.duration, lyrics: lyrics);
                    sheetNotes.add(sn);
                  }
                } else
